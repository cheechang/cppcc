...
function retrieveSourceMap(source) {
  ...
  // if (is.dev() && path.startsWith('http://')) {
  //   try {
...
const stackFrameMap = new WeakMap()
 ...
 */
export function withSourceMappedStack(error) {
  return {
    name: error.name,
...
function sourceMappedStackTrace(error) {
