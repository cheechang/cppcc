...
namespace ui{
	SetSecretChatDialog::SetSecretChatDialog(QWidget *parent):BaseWindow(parent)
	{
	...
	SetSecretChatDialog::~SetSecretChatDialog()
	{
	
	}

	void SetSecretChatDialog::onPlainOrcipher()
	{
	...
	void SetSecretChatDialog::onAckBtnClicked()
	{
	...
	void SetSecretChatDialog::onCancelBtnClicked()
	{
		emit signalCancelSet();
		accept();
	}

	void SetSecretChatDialog::onclose()
	{
		close();
		emit signalclose();
	}
