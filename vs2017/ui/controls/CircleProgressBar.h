/*
 * CircleProgressBar - a circular progress bar Qt widget.
 *
...
/**
 * @brief The CircleProgressBar class represents a circular progress bar and maintains its API
 * similar to the *QProgressBar*.
 *
 * ### Styles
 * CircleProgressBar currently supports Donut, Pie and Line styles. See setBarStyle() for more details.
 *
 * ### Colors
 * Generally CircleProgressBar uses its palette and font attributes to define how it will look.
 *
 ...
 *
 * ### Value text
 * Value text is generally drawn inside the CircleProgressBar using its `font()` and \a QPalette::Text role from its `palette()`.
 *
