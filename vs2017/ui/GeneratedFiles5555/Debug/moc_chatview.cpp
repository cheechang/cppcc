...
#include <memory>
#include "../../mainwindow/chat/bubble/chatview.h"
...
QT_MOC_LITERAL(1, 9, 9), // "hideAtWin"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "ChatView\0hideAtWin\0"
};
...
void ChatView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChatView::hideAtWin)) {
                *result = 0;
                return;
            }
        }
