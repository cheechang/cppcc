...
#include <memory>
#include "../../mainwindow/chat/bubble/eventfilter.h"
...
QT_MOC_LITERAL(1, 12, 13), // "eventFiltered"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7), // "QEvent*"
QT_MOC_LITERAL(4, 35, 5) // "event"

    },
    "EventFilter\0eventFiltered\0\0QEvent*\0"
    "event"
};
...
void EventFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->eventFiltered((*reinterpret_cast< QEvent*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (EventFilter::*)(QEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventFilter::eventFiltered)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void EventFilter::eventFiltered(QEvent * _t1)
{
