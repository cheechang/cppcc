...
public:
	...
	int padEncrypt_t(const UINT8 *input, int inputOctets, UINT8 *outBuffer, bool isLast);
	...
	int padDecrypt_t(const UINT8 *input, int inputOctets, UINT8 *outBuffer,bool isLast);
