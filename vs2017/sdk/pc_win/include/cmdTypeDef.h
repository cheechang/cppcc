...
enum  
{
    ...
    */
    ...
    /**
    * [in] req_zxSearch
    * [out] resp_zxSearchResult
    */
    logic_cmd_zxSearch = 0xD7,
	/**
	* [in] req_zxSearchFavo
	* [out] resp_zxSearchFavoResult
	*/
	logic_cmd_zxSearchFavo = 0xD8,
	/**
	* [in] req_zxFavorite
	* [out] resp_commonResult
	*/
	logic_cmd_zxFavorite = 0xD9,
	/**
	* [in] req_zxDelFavo
	* [out] resp_commonResult
	*/
	logic_cmd_zxDelFavo = 0xDA,
	/**
	* [in] req_zxDelFavo
	* [out] resp_commonResult
	*/
	logic_cmd_zxTopInformation = 0xDB,
	/**
	* [in] req_zxGetTopInfo
	* [out] resp_zxGetTopResult
	*/
	logic_cmd_zxGetTopInfo = 0xDC,
	/**
	* [in] req_getMemberInfo
	* [out] resp_getGroupMemberInfo
	*/
	logic_cmd_getMemberFromNet = 0xDD,
	/**
	* [in] req_getBatchMember
	* [out] resp_getGroupMemList
	*/
	logic_cmd_getBatchMember = 0xDE,
	logic_cmd_max
};
