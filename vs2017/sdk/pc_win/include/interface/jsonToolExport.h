...
struct jst_FileMsg :public jst_MediaMsgBase{
	jst_FileMsg() :fileSize(0), fileID(0), operateType(0), fileStates(0), isFolder(0){}
...
struct jst_SubMsgProperties{
	jst_SubMsgProperties() :deviceType(0), revokeMsgId(0), timeZone(-1), delayTime(0), operType(0), extendmsgtype(-1), isPrivateMsg(0), textSize(0), isdeal(0), iscmd(false), bwdtype(0), isOri(0), isFeather(0),validity(0){};
