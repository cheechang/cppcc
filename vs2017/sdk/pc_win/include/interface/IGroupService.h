...
public:
	...
	* @param[in] _2 群成员列表
	*/
	virtual void regGetGrpMemListCb(SFunction<void(ErrorInfo, std::vector<SSharedPtr<Member> >&)> cb) = 0;
	...
	*/
	virtual void getGroupMemberFromNet(int64 groupId, int64 memberID, SFunction<void(ErrorInfo, Member&)> cb) = 0;
	...
	*/
	virtual void getBatchMemberByID(int64 groupId, std::vector<int64>& memberIDs, SFunction<void(ErrorInfo, std::vector<SSharedPtr<Member> >&)> cb) = 0;
