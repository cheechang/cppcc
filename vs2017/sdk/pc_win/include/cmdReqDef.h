...
namespace imsdk
{
	...
	*/
	...
	/**
	 *  \struct req_getBatchMember
	 *  \brief 批量获取群成员
	 */
	struct req_getBatchMember : public _sdkcmd_base {
		int64 groupid;
	...
	*/
	...
	{
		req_queryMarketApplication() :pageNum(0), pageSize(0), deviceType(0)
		{
			INIT_ISSET(appName)
		}
	...
	*/
	...
	/**
	* \struct req_getAuthUserBean 消息号 logic_cmd_getAuthUserBean
	...
	*/
    ...
    struct req_zxSearch : public _sdkcmd_base
    {
        req_zxSearch() :pageNum(0), pageSize(0), SDKID(0)
        {}
        ...
        void init()
        {
            ...
            group.clear();
            specialCommittee.clear();
            specialCommitteeDuty.clear();
            CPPCCPosition.clear();
            myLocation.clear();
			isWhite = 0;
        }
	...
	struct req_zxFavoSearch : public _sdkcmd_base
	{
		int32 pageIndex;
		int32 pageSize;
		int64 groupId;
		...
		req_zxFavoSearch() :pageIndex(0), pageSize(0), groupId(0), favoUserId(0)
		{}
	...
	struct req_zxFavorite : public _sdkcmd_base
	{
		st_zxFavorite favo;
	...
	struct req_zxDelFavo : public _sdkcmd_base
	{
		int64 favoriteId;
		int64 favoUserId;

		req_zxDelFavo(): favoriteId(0), favoUserId(0)
		{}
	};

	//政协收藏置顶
	struct req_zxTopInformation : public _sdkcmd_base
	{
		st_zxTopInfo info;
		int operType;	// 5.新增 6.修改 7.删除
	...
	struct req_zxGetTopInfo : public _sdkcmd_base
	{
		int64 groupId;
		int32 pageNum;
		int32 pageSize;

		req_zxGetTopInfo() : groupId(0), pageNum(0), pageSize(0)
		{}
		void init()
		{
			groupId = 0;
