...
public:
	Msg() :msgType(0), msgId(0), targetId(0), fromId(0), toId(0),
		relatedUsers(0), relatedMsgId(0), noStore(0), time(0), localId(0), 
		isPrivateMsg(0), timeZone(-1), isBurn(0), activeType(0), deal(false), 
		msgRemindMode(0), isOri(false), isFeather(0),
		unReadCount(0), maxUnReadCount(0), snapshotId(0)
	{}
	virtual ~Msg() {}
...
{
public:
	MsgFile() :isDelay(false), states(0), size(0), fileId(0), isOld(false), delayTime(0), isResume(false), isFolder(0), isReceipt(false), validity(0)
	{ 
	...
	MsgFile(Msg& msg) :Msg(msg), isDelay(false), states(0), size(0), fileId(0), isOld(false), delayTime(0), isResume(false), isFolder(0), isReceipt(false), validity(0)
	{
		msgType = MSG_TYPE_FILE;
	}
	~MsgFile(){}
...
{
public:
	MsgImg() :isDelay(false), width(0), height(0), isCmd(false), isOld(false), buddyId(0), delayTime(0), isReceipt(0), validity(0)
	{ 
	...
	MsgImg(Msg& msg) :Msg(msg), isDelay(false), width(0), height(0), isCmd(false), isOld(false), buddyId(0), delayTime(0), isReceipt(0), validity(0)
	{
		msgType = MSG_TYPE_IMG;
	}
	~MsgImg(){}
...
struct ImgMsgInner{
	...
	ImgMsgInner() :docID(1),toId(0), fromId(0), msgType(MSG_TYPE_IMG), msgId(0), time(0), height(0), width(0), buddyId(0), isDelay(0), delayTime(0), isCmd(false){}
	int64 toId;
	int64 fromId;
	std::string userName;
	std::string userPic;
